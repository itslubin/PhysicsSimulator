...
public class Vector2D { // Es una clase no modificable, a pesar de que no se puede indicar en java
	...
	public boolean equals(Object obj) {
		...
		//if (Math.abs(_x - other._x ) > 0.1 ) return false;
		//if (Math.abs(_y - other._y ) > 0.1 ) return false;
