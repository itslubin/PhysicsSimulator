...
class BodiesGroupTest {
	...
	//static void assertEqVector2D(Vector2D a, Vector2D b, double delta, String msg) {
	//	assertEquals(a.getX(), b.getX(), delta, msg);
	//	assertEquals(a.getY(), b.getY(), delta, msg);
	//}
	@Test
...
//		assertEqVector2D(new Vector2D(4.895824312170701, 2.540013828915411), b4.getPosition(),
//				0.1,"MovingBody.getPosition returned a wrong value after calling (group) advance");

		
//		double a=1.123, b=1.234;
